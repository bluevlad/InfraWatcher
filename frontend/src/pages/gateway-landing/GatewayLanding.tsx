...
const CONNECTED_SERVICES: Connected[] = [
  { name: 'AllergyInsight', role: '실시간 관제 대상', href: 'https://allergyinsight.unmong.com/', dot: '#f43f5e' },
  { name: 'SkillRadar', role: '실시간 관제 대상', href: 'https://skillradar.unmong.com/', dot: '#22c55e' },
  { name: 'NewsLetterPlatform', role: '실시간 관제 대상', href: 'https://newsletter.unmong.com/', dot: '#ec4899' },
  { name: 'unmong', role: '실시간 관제 대상', href: 'https://www.unmong.com/', dot: '#3b82f6' },
