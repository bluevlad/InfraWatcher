...
from app.api import admin, auth, health, containers, system, healthcheck, websocket, container_history, groups, loganalyzer
...
app.include_router(loganalyzer.router, prefix="/api", tags=["loganalyzer"])
